...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if ("1".equals(input)) {
                if (notepad != null) {
                    System.out.println("Are you sure you want to create new Notepad?" +
            ...
            if ("2".equals(input)) {
                if (notepad == null) {
                    System.out.println("Notepad isn't created yet");
                } else {
                    noteCreation();
                }
            }
    ...
    public static void createNotepad() {
        ...
        try {
            ...
            sep();
            System.out.println("Notepad's created!");
            sep();
        } catch (Exception e) {
    ...
    public static void noteCreation() {
        ...
        try {
            ...
            if (notepad.notes[tmp1 - 1] != null) {
                sep();
                System.out.println("Note is already there. Want to replace it? (y/n)");
                sep();
                ...
                sep();
                System.out.println("Note's added to page " + tmp1);
                sep();
            }
    ...
    public static void noteEdition() {
        ...
        try {
            ...
            if (tmp1 > notepad.numberOfPages || tmp1 <= 0 || notepad.notes[tmp1 - 1] == null) {
                ...
                sep();
                System.out.println("Note is edited");
                sep();
            }
        } catch (NumberFormatException e) {
            System.out.println("Enter a valid number");
